...
>1. 9月初-9月底，复习计算机三级网络技术，完成考试。
>2. 10月初-10月底，复习银行从业相关知识，完成考试。
>3. 9月开始，学习 React、React Native，和飞哥着手开始做 APP，deadline 大概是今年年底。
>4. 平时多看看 JS 相关的基础知识和算法，年底之前把屯的书看完。
>5. 每天学英语！12月再考一次六级，希望可以考过600分。
